        ...
        <div class="modal-dialog modal-primary">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="first_name">Primer Nombre <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="birth_date">F. Nacimiento</label>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="porcentage_commission">Porcentaje de Comisión </label>
                            <input type="number" name="porcentage_commission" min="1" max="100" pattern="[0-9]*" class="form-control">
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" class="btn btn-primary btn-save-worker" value="Guardar">
                </div>
            </div>
        </div>
    </div>
