                                ...
                                <tbody>
                                    ...
                                    @forelse ($cashier->expenses as $item)
                                        <tr @if ($item->deleted_at) style="text-decoration: line-through; color: red;" @endif>
                                            ...
                                            <td>    
                                                @if ($item->deleted_at == null && $cashier->status == 'Abierta')
                                                    <a href="#" title="Eliminar" class="btn btn-sm btn-danger pull-right delete" data-toggle="modal" data-target="#modal-delete" onclick="deleteItem('{{ route('expenses.destroy', ['expense' => $item->id]) }}')">
                                                        <i class="voyager-trash"></i>
                                                    </a>
                                                @endif                                            
                                                {{ $item->observation }} <br>
                                    ...
                                    @empty
                                        <tr>
                                            <td style="text-align: center" colspan="5">No hay datos</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                                <tfoot>
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-right"><span class="text-danger"><b>TOTAL
                                                    ANULADO</b></span></td>
                                        <td class="text-right"><b
